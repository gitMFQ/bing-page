...
const home = async (pathname) => {
  ...
  if (CUSTOM_OPTIONS.NIGHTLY) {
    ...
    baseUrl = 'https://raw.githubusercontent.com/gitMFQ/go-proxy-bingai/master/';
  }
  let url;
...
export default {
  ...
  async fetch(request, env, ctx) {
    ...
    if (isMobile) {
      ...
      newHeaders.set('user-agent', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Safari/537.36 Edg/124.0.2447.0');
    }
